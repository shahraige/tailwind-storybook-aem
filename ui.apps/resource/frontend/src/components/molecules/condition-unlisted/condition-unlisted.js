...
const ConditionUnlisted = props => {
    const { requireinfoText } = props;
    return (
        <div className='condition-unlisted section'>
            <div className='condition-unlisted__inner'>
                <div className='condition-unlisted__banner'>

                    <div className='condition-unlisted__banner__inner'>
                        <HeadlineText>
                            <h1>
                                <span className="verveine-text underline-text">
                                    I can't see the condition listed
                                </span>
                            </h1>
                        </HeadlineText>                        
                    </div>
                ...
                <div className="condition-unlisted__wrapper">
                    <div className="condition-unlisted__details">
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <HeadlineText>                                        
                                        <p>Your doctor is likely to be providing you with lots of support, and there are also specific patient association websites that can help with understanding more about your condition, ideas on how to manage it and also provide you with a network of others that have the same condition. There are often both global and local versions of these types of websites and these can be found by searching online.</p>
                                    </HeadlineText>
                                    <Separator 
                                        size="size-1"
                                        marginY="my-3"
...
export default ConditionUnlisted