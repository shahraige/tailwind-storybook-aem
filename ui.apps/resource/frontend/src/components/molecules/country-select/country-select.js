...
const CountrySelect = props => {
    ...
    return (
        <div class="control-group form-group form-group--select input-field country-select">
            {/* <label for="select-country">Country:</label> */}
            <select id="" class="country_selector form-control">
            ...
            <div className="right-text-action">
                {
                    props.requireinfoText ? (
                        ...
                        >
                            {/* <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enableBackground="new 0 0 524.235 524.235" height="24" width="24" version="1.1" x="0" y="0" viewBox="0 0 524.235 524.235"  class=""><path stroke="red" d="M213.333,0C95.467,0,0,95.467,0,213.333s95.467,213.333,213.333,213.333S426.667,331.2,426.667,213.333S331.2,0,213.333,0    z M234.667,320H192V192h42.667V320z M234.667,149.333H192v-42.667h42.667V149.333z" fill="#9497a2" data-original="#000000" class=""/></svg> */}
