...
storiesOf('Molecules | Headline Text', module)
    .add('Headline with Text', () => {
        //const label = text('Text', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.');
        //const value = select(slabel, options, defaultValue);
        return (
            <HeadlineText customClass="">
